...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_classes=45):
        ...
        self.conv1 = SConv_2d(Coefficient = Coefficient_3, in_channels=3, out_channels=64, kernel_size=3, feat_stride=1, conv_stride=1, padding=1)
